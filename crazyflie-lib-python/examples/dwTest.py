...
DRONE7 = 'radio://1/70/2M/E7E7E7E708'
DRONE8 = 'radio://1/70/2M/E7E7E7E709'
DRONE9 = 'radio://1/70/2M/E7E7E7E710'
...
def position_callback(timestamp, data, logconf):
    ...
    t = time.time()
    output = open('spiral03.csv', 'a')
    output.write('{}, {}, {}, {}\n'.format(t, x, y, z))

def start_position_printing(scf: SyncCrazyflie):
...
if __name__ == '__main__':
    ...
    for key in trajectory_assigment.keys():
        ...
        """test height: 0.3 0.5 0.7 0.9"""

        h = 0.5

        trajectory = traj_list[str(h)]
